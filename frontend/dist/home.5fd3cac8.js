...
},{}],"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{}],"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js":[function(require,module,exports) {
...
},{}],"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/isarray/index.js":[function(require,module,exports) {
var toString = {}.toString;
...
},{}],"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js":[function(require,module,exports) {
...
},{"base64-js":"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/base64-js/index.js","ieee754":"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/ieee754/index.js","isarray":"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/isarray/index.js","buffer":"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/qrcode/lib/utils/typedarray-buffer.js":[function(require,module,exports) {
...
},{"isarray":"node_modules/isarray/index.js","buffer":"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/qrcode/lib/core/utils.js":[function(require,module,exports) {
var toSJISFunction;
...
},{"../utils/buffer":"node_modules/qrcode/lib/utils/typedarray-buffer.js","./polynomial":"node_modules/qrcode/lib/core/polynomial.js","buffer":"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"node_modules/qrcode/lib/core/version-check.js":[function(require,module,exports) {
/**
...
exports.getJSON = exports.postJSON = exports.APIs = exports.HOST = void 0;
...
var postJSON = function postJSON(url) {
  ...
  return $.post(url, data).done(function (res) {
    ...
    return alert("Payment fail", error);
  });
};

exports.postJSON = postJSON;

var getJSON = function getJSON(url, done, fail) {
  return $.get(url).done(function (res) {
    return done(res);
  }).fail(function (error) {
    return alert("Request fail", error);
  });
};
...
var ZaloPay = /*#__PURE__*/function () {
  ...
  _createClass(ZaloPay, null, [{
    ...
    value: function Pay(url) {
      ...
      var done = arguments.length > 2 ? arguments[2] : undefined;
      return (0, _common.postJSON)(url, params, done, function () {
        alert("Thanh toan that bai");
      });
    }
  }, {
    key: "QRPay",
    value: function QRPay(params, done) {
      ZaloPay.Pay(_common.APIs.QR, params, done);
    }
  }, {
    key: "Gateway",
    value: function Gateway(params, done) {
      ZaloPay.Pay(_common.APIs.GATEWAY, params, done);
    }
  }, {
    key: "QuickPay",
    value: function QuickPay(params, done) {
      ZaloPay.Pay(_common.APIs.QUICKPAY, params, done);
    }
  }, {
    key: "GetBankList",
    value: function GetBankList(done) {
      return (0, _common.getJSON)(_common.APIs.GETBANKLIST, function (data) {
...
function showQRCode(data) {
  ...
  _qrcode.default.toCanvas($qrcode, data);
}
...
$payForm.submit(function (event) {
  ...
  switch (activeTab) {
    case "gateway":
      ...
      _zalopay.ZaloPay.Gateway(params, function (data) {
    ...
    case "quickpay":
      ...
      _zalopay.ZaloPay.QuickPay(params, function (data) {
        alert("Thanh toan thanh cong");

        _zalopay.ZaloPay.ListenCallback(data.apptransid, hideLoading);
      });

      break;

    default:
      _zalopay.ZaloPay.QRPay(params, function (data) {
        showQRCode(data.orderurl);
        $web2appLink.attr("href", data.orderurl);

        _zalopay.ZaloPay.ListenCallback(data.apptransid);
      });

      break;
  }
});
},{"qrcode":"node_modules/qrcode/lib/browser.js","./zalopay":"js/zalopay.js"}],"../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../.nvm/versions/node/v12.14.1/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/home.js"], null)
